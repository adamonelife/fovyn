const CACHE='forbair-v2-charcoal-brand';
self.addEventListener('install',event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(['/','/brand/forbair-app-icon-charcoal.png']))));
