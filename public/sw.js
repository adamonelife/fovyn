const CACHE='forbair-v1-workout-shell';
self.addEventListener('install',event=>event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(['/','/brand/forbair-mark.png']))));
