...
type Mode='tree'|'environment'|'nursery-slots';
...
export default function ForestLabQA({close}:{close:()=>void}){
  ...
  const key=mode==='tree'?tree.assetKey:mode==='nursery-slots'?'forest.environment.nursery':environmentAssetKey(environment);
