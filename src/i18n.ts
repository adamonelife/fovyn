...
const en={
  ...
  training:{names:{title:'Standard movement',intro:'Choose the shared movement identity, then keep your own machine or shorthand name as a private alias.',search:'Search standard names',searchPlaceholder:'Search press, row, squat…',custom:'Use a custom exercise instead',identity:'Standard identity:',alias:'Your exercise name / alias',aliasHelp:'Private to your Exercise Profile. Examples: Hotel cable, old gym press, 1h row.',unavailable:'Standard exercise names are unavailable right now.'}}
} as const;
