...
export type SearchResult={id:string;type:'Goal'|'Habit'|'Logging item'|'Record'|'Note'|'Sleep'|'Activity'|'Nutrition'|'Money'|'Hobby';title:string;detail:string;destination:SearchDestination};
