...
export async function loadHome():Promise<HomeData>{
  ...
  const[goals,habits,recent,configured,yesterdayRecords,yesterdayRoundup,currentClearing,clearingReview]=await Promise.all([
